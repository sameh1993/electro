          ...
          <div class="input-group">
            ...
            <div class="input-group-addon search-categories">
              ...
              >
                ...
                <option class="level-0" value="laptops-laptops-computers">
                  Laptops
                </option>
                <option class="level-0" value="ultrabooks-laptops-computers">
                  Ultrabooks
                </option>
                <option class="level-0" value="mac-computers-laptops">
                  Mac Computers
                </option>
                <option class="level-0" value="all-in-one-laptops-computers">
                  All in One
                </option>
                <option class="level-0" value="servers">Servers</option>
                <option class="level-0" value="peripherals">Peripherals</option>
                <option class="level-0" value="gaming-laptops-computers">
                  Gaming
                </option>
                <option class="level-0" value="accessories-laptops-computers">
                  Accessories
                </option>
                <option class="level-0" value="audio-speakers">
                  Audio Speakers
                </option>
                <option class="level-0" value="headphones">Headphones</option>
                <option class="level-0" value="computer-cases">
                  Computer Cases
                </option>
                <option class="level-0" value="printers">Printers</option>
                <option class="level-0" value="cameras">Cameras</option>
                <option class="level-0" value="smartphones">Smartphones</option>
                <option class="level-0" value="game-consoles">
                  Game Consoles
                </option>
                ...
                <option class="level-0" value="headphone-accessories">
                  Headphone Accessories
                </option>
                <option class="level-0" value="headphone-cases">
                  Headphone Cases
                </option>
          ...
          <li class="nav-item dropdown">
            <a href="cart.html" class="nav-link" data-toggle="dropdown">
              ...
              <span class="cart-items-total-price total-price"
                ><span class="amount">$1,215.00</span></span
              >
            </a>
                ...
                <div class="widget_shopping_cart_content">
                  <ul class="cart_list product_list_widget">
                    <li class="mini_cart_item">
                      ...
                      <span class="quantity"
                        >2 × <span class="amount">£150.00</span></span
                      >
                    </li>
                    ...
                    <li class="mini_cart_item">
                      ...
                      <span class="quantity"
                        >1 × <span class="amount">£399.99</span></span
                      >
                    </li>
                      ...
                      <a href="single-product.html">
                        <img
                          class="
                            ...
                            wp-post-image
                          "
                          src="@/assets/images/products/mini-cart3.jpg"
                          alt=""
                        />POV Action Cam HDR-AS100V&nbsp;
                      </a>

                      <span class="quantity"
                        >1 × <span class="amount">£269.99</span></span
                      >
                    </li>
                  </ul>
                  <!-- end product list -->
                  ...
                  <p class="total">
                    ...
                    <span class="amount">£969.98</span>
                  </p>

                  <p class="buttons">
                    <a class="button wc-forward" href="cart.html">View Cart</a>
                    <a class="button checkout wc-forward" href="checkout.html"
                      >Checkout</a
                    >
                  </p>
                </div>
        ...
        <div class="handheld-navigation-wrapper">
          ...
          <div class="handheld-navigation hidden-lg-up" id="default-hh-header">
            ...
            <ul id="menu-all-departments-menu-1" class="nav nav-inline yamm">
              ...
              <li class="highlight menu-item animate-dropdown">
                <a title="New Arrivals" href="home-v3-full-color.html"
                  >New Arrivals</a
                >
              </li>
              <li
                    ...
                    <div class="yamm-content">
                      <div class="col-sm-6">
                        <ul>
                          ...
                          <li>
                            <a href="#"
                              >All Consoles, Games &amp; Accessories</a
                            >
                          </li>
                    ...
                    <div class="yamm-content">
                      ...
                      <div class="col-sm-6">
                        <ul>
                          ...
                          <li>
                            <a href="#">Janitorial &amp; Sanitation Supplies</a>
                          </li>
              ...
              >
                ...
                <ul role="menu" class="dropdown-menu">
                  ...
                  <li class="menu-item animate-dropdown">
                    <a title="Chargers" href="product-category.html"
                      >Chargers</a
                    >
                  </li>
                  <li class="menu-item animate-dropdown">
                  ...
                  <li class="menu-item animate-dropdown">
                    <a title="Headphone Cases" href="product-category.html"
                      >Headphone Cases</a
                    >
                  </li>
                  <li class="menu-item animate-dropdown">
                    <a title="Headphones" href="product-category.html"
                      >Headphones</a
                    >
                  </li>
                  <li class="menu-item animate-dropdown">
                    <a title="Computer Accessories" href="product-category.html"
                      >Computer Accessories</a
                    >
                  </li>
                  <li class="menu-item animate-dropdown">
                    <a title="Laptop Accessories" href="product-category.html"
...
.navbar-search button {
  border-radius: 0 2.571em 2.571em 0;
}
